...
func initJaeger(service string) (opentracing.Tracer, io.Closer) {
    cfg := &jaeger_config.Configuration{
        ...
        Reporter: &jaeger_config.ReporterConfig{
            LogSpans: true,
            CollectorEndpoint: "http://jaeger-collector.clover-system:14268/api/traces",
            LocalAgentHostPort: "jaeger-agent.clover-system:6831",
        },
    }
...
func main() {
    ...
    */
    ...
    fmt.Println("Beginning network tracing")
